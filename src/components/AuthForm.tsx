...
export function AuthForm({ state }: IAuthFormProps) {
  ...
  const checkIsEmpty = () => {
    if (email === '' || password === '') {
      setErrorForm('Email dan password wajib diisi ya.')
      return true
    }
        ...
        <Stack spacing={4} mt="4">
          ...
          <Stack spacing={10}>
            {isLogin ? (
              ...
              >
                <Button variant="link" as={Link} color={'#008DEF'} href={forgetPasword}>
                  Lupa password?
                </Button>
              </Stack>
            ) : null}
          ...
          {isLogin ? (
            <Stack direction="row" align={'center'} justify={'center'}>
              ...
              <Button variant="link" as={Link} color={'#008DEF'} onClick={toggleState}>
                Daftar sekarang
              </Button>
            </Stack>
          ) : (
